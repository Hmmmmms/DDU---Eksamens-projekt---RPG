...
public class TaskPatrol_Skeleton : Node
{
    ...
    public TaskPatrol_Skeleton(Transform transform, Transform[] waypoints)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        else
        {
            ...
            {
                _transform.position = Vector2.MoveTowards(_transform.position, wp.position, SkeletonBT.speed * Time.deltaTime);
                _animator.SetBool("isMoving", true);
